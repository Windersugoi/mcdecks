...
interface Props { activeDeck: Deck | null; warn?: string; }

export function ActiveDeckBanner({ activeDeck, warn }: Props) {
  const C = useColors();
...
function getStyles(C: typeof DarkColors) {
  return StyleSheet.create({
    ...
    warn:    { borderWidth:1, borderColor:C.warning+'55', backgroundColor:C.warningBg, borderRadius:Radius.md, padding:Spacing.sm },
